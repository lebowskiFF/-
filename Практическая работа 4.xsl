				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>Наличие в ГОС Реестре</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Новинка селекции</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Новинка прайса</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Лидер продаж</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Цена мелкий опт, руб</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Цена опт, руб</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Поле27</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="База_x0020_данных">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="Код1"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Наличие_x0020_в_x0020_ГОС_x0020_Реестре', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Номенклатура', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Описание', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Сайт', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Новинка_x0020_селекции', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Новинка_x0020_прайса', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Лидер_x0020_продаж', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Латинское_x0020_название', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Код', '0', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Цена_x0020_мелкий_x0020_опт_x002C__x0020_руб', '#,##0', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="Цена_x0020_опт_x002C__x0020_руб"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Заказ', '@', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Сумма', '#,##0.00 ?;-#,##0.00 ?', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Штрихкод', '0', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Доступность', '0', '', '', 8)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Поле27', '@', '', '', 8)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
